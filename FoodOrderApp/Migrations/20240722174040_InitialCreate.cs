    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AddressListAddressId = table.Column<int>(type: "INTEGER", nullable: false),
                    UsersUserId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AddressUser", x => new { x.AddressListAddressId, x.UsersUserId });
                    table.ForeignKey(
                        name: "FK_AddressUser_Addresses_AddressListAddressId",
                        column: x => x.AddressListAddressId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProductVarId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ProductId = table.Column<int>(type: "INTEGER", nullable: false),
                    Price = table.Column<decimal>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductVars", x => x.ProductVarId);
                    table.ForeignKey(
                        name: "FK_ProductVars_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductVarId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Materials", x => x.MaterialId);
                    table.ForeignKey(
                        name: "FK_Materials_ProductVars_ProductVarId",
                        column: x => x.ProductVarId,
                        principalTable: "ProductVars",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Materials_ProductVarId",
                table: "Materials",
                column: "ProductVarId");
